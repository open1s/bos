...
const { initTracing, version } = require('../index.js');
...
async function main() {
  ...
  // Initialize tracing - reads BOS_LOG env or config
  console.log('  🔧 Initializing tracing via initTracing()...');
  initTracing();
  console.log('  ✅ Tracing initialized');

  // Use bus to generate logs
  ...
  // Also test query/call for more log output
